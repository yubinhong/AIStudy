...
- [x] 发布质量与 Ubuntu 拉取式部署完成：提交 `4317cdd` 的 quality run `34555617183` 的 contracts/API/Web/browser-e2e/release-notes、API/Web GHCR 均成功；Ubuntu 备份/隔离恢复、`sha-4317cdd` 拉取式切换、health、OpenAPI Tutor 路由、`0039` head、worker、digest/revision、MinIO 私有端口和容器源码检查通过。
