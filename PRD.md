...
| FR-022 | 家长学习记录与保留 | Must | 工作台“今日需要关注”只列出上海自然日当天到期的开放错题；更早到期的开放错题不在首页展示但仍可从学习记录/复习入口访问。独立记录页默认查询最近 30 个上海自然日，可选择 180 天窗口内单日。API 使用带时区 UTC 半开区间，单次最多 31 天/500 条并保持 Household/Child 授权。详细 VerifiedQuestion/TutorTurn 和已结束复习链路保留 180 天；开放错题及其题目不清理，Attempt/AuditEvent/账号/教材不在本策略范围 | 日期/时区/当天、过期、未来边界/上限/授权、空状态、开放错题保护、幂等批次清理、迁移索引和生命周期日志测试 |
