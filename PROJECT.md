...
面向小学阶段家庭、可复用现有 iPad、Windows 和手机的开源 AI 学习助手；以数学为首科，围绕“家庭教材范围 → 错题讲解 → 错题沉淀 → 到期复习 → 今日任务/家长反馈”形成可追溯闭环。
...
以下为 v1.0 设计确定的结构；P0/P1 核心领域已实现到单家庭自用闭环，状态以各表格和 `TESTING.md` 为准。
