...
面向小学阶段家庭、可复用现有 iPad、Windows 和手机的开源 AI 学习助手；以数学为首科，围绕“家庭教材范围 → 错题讲解 → 错题沉淀 → 到期复习 → 家长反馈”形成可追溯闭环。
...
- Windows 原生 Flutter Desktop、语文插件、无限自由语音聊天、真实英语语音 Provider 和 Python 游戏化模块不属于当前 P1 交付；英语只交付默认锁定的供应商中立有界框架。
...
- 孩子登录后的数学/英语学科选择，以及默认锁定的三个有界英语口语情景框架；英语不进入数学任务模型，真实语音 Provider 未经合规批准前不开放。
